...
def generate_output_filename(city, theme_name):
    ...
    filename = f"{city_slug}_{theme_name}_16x20_{timestamp}.png"
...
def create_poster(city, country, point, dist, output_file, width=16, height=20):
    ...
    print(f"Output dimensions: {width}\" x {height}\" at 300 DPI (16x20 inch matte paper)")
...
def print_examples():
    ...
    print("""
City Map Poster Generator (16x20 inch format)
==============================================

This version creates maps optimized for 16x20 inch matte paper printing.
It excludes residential and small roads, showing only major arteries:
- Motorways/Highways
- Trunk roads
- Primary roads
- Secondary roads
...
Usage:
  python create_map_poster_16x20.py --city <city> --country <country> [options]

Examples:
  # Iconic grid patterns
  python create_map_poster_16x20.py -c "New York" -C "USA" -t noir -d 12000
  python create_map_poster_16x20.py -c "Barcelona" -C "Spain" -t warm_beige -d 8000

  # Waterfront & canals
  python create_map_poster_16x20.py -c "Venice" -C "Italy" -t blueprint -d 4000
  python create_map_poster_16x20.py -c "Amsterdam" -C "Netherlands" -t ocean -d 6000

  # Radial patterns
  python create_map_poster_16x20.py -c "Paris" -C "France" -t pastel_dream -d 10000
  python create_map_poster_16x20.py -c "Moscow" -C "Russia" -t noir -d 12000

  # List themes
  python create_map_poster_16x20.py --list-themes
...
Output: 16x20 inches at 300 DPI (4800x6000 pixels)
""")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate beautiful 16x20 inch map posters for any city (major roads only)",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python create_map_poster_16x20.py --city "New York" --country "USA"
  python create_map_poster_16x20.py --city Tokyo --country Japan --theme midnight_blue
  python create_map_poster_16x20.py --city Paris --country France --theme noir --distance 15000
  python create_map_poster_16x20.py --list-themes
        """
    )
    ...
    print("(16x20 inch format - Major Roads Only)")
    print("=" * 50)
